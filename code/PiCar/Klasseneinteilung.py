...
dir_out = "D:\\+Bilder\\Seminararbeit\\Datensatz_klassen"
train_dir = "train"
valid_dir = "valid"
...
def teileInArray(X, y):
    ...
    for i in range(0, len(X)):
        num = int(y[i]/20) + 1 #Klassen von 1 bis 10
        A[num - 1].append(X[i]) #aber indezes von 0 bis 9
        b[num - 1].append(y[i])
    return A, b
